(function(){
	...
	function solve(network, maxSolutions, solutions, tryingChoices) {
	...
	Utils.extendModule(Network, "./TableNode.js", /** @lends Network */ {
		...
		/**
		 * @returns true if this network represents a solved 
		 */
